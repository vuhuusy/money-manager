package com.syvh.moneymanager.service;
...
import com.syvh.moneymanager.repository.ProfileRepository;
...
public class ProfileService {
    ...
    public ProfileDTO registerProfile(ProfileDTO profileDTO) {
        ...
        String body = "Click the following link to activate your account: " + activationUrl;
    ...
    public ProfileEntity getCurrentProfile() {
        ...
        .orElseThrow(() -> new UsernameNotFoundException("Profile not found for user: " + authentication.getName()));
    }
